...
export const testFieldType = function (List) {
    describe('updateItem', function () {
        it('should update top level fields', function (done) {
            ...
            List.fields.email.updateItem(testItem, {
                ...
                demand(testItem.email).be.equal('sebastian@thinkmill.com.au');
                done();
            });
        });
        ...
        it('should update nested fields', function (done) {
            ...
            List.fields['nested.email'].updateItem(testItem, {
                ...
                demand(testItem.nested.email).be.equal('sebastian@thinkmill.com.au');
                done();
            });
        });
    ...
    describe('gravatarUrl', function () {
        ...
        it('should return an empty string if no email is specified', function () {
            ...
            demand(testItem2._.email.gravatarUrl()).be.equal('');
        });

        it('should return the correct url when an email is specified', function () {
            demand(testItem._.email.gravatarUrl()).be.equal('//www.gravatar.com/avatar/45eed6685108e64b67f79fb056d95a64?s=80&d=identicon&r=g');
        });

        it('should handle the size option', function () {
            demand(testItem._.email.gravatarUrl(50)).be.equal('//www.gravatar.com/avatar/45eed6685108e64b67f79fb056d95a64?s=50&d=identicon&r=g');
        });

        it('should handle the defaultImg option', function () {
            demand(testItem._.email.gravatarUrl(null, 'https://avatars1.githubusercontent.com/u/853712')).be.equal('//www.gravatar.com/avatar/45eed6685108e64b67f79fb056d95a64?s=80&d=https%3A%2F%2Favatars1.githubusercontent.com%2Fu%2F853712&r=g');
        });

        it('should handle the rating option', function () {
            demand(testItem._.email.gravatarUrl(null, null, 'pg')).be.equal('//www.gravatar.com/avatar/45eed6685108e64b67f79fb056d95a64?s=80&d=identicon&r=pg');
        });
    });
