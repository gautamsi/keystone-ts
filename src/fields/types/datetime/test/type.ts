    ...
    describe('invalid options', function () {
        it('should throw when format is not a string', function (done) {
            try {
                ...
                demand(err.message).eql('FieldType.Date: options.format must be a string.'); // need to be FieldType.Date not FieldType.DateTime due to inheritance.
                done();
            }
        });
    });
    ...
    describe('updateItem', function () {
        it('should update the date', function (done) {
            ...
            List.fields.datetime.updateItem(testItem, {
                ...
                demand(testItem.datetime.toDateString()).be.equal('Thu Jan 01 2015');
                done();
            });
        });
