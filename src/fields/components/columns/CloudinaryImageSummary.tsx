...
export class CloudinaryImageSummary extends React.Component<Props> {
    static displayName: string = 'CloudinaryImageSummary';
    renderLabel() {
    ...
    renderImageThumbnail() {
        ...
        return <img src={url} style={imageStyle as any} className="img-load" />;
    }
    render() {
        return (
            <span style={linkStyle}>
                <span style={boxStyle as any}>
